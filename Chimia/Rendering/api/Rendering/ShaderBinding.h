...
public:
  ...
  static ShaderBinding Float(const InstancedDataBuffer& data,
                             const unsigned location,
                             const unsigned nEntries,
                             const unsigned offset);

  static ShaderBinding Double(const InstancedDataBuffer& data,
                              const unsigned location,
                              const unsigned nEntries,
                              const unsigned offset);

  static ShaderBinding Int(const InstancedDataBuffer& data,
                           const unsigned location,
                           const unsigned nEntries,
                           const unsigned offset);

  static ShaderBinding UnsignedInt(const InstancedDataBuffer& data,
                                   const unsigned location,
                                   const unsigned nEntries,
                                   const unsigned offset);

  static ShaderBinding Short(const InstancedDataBuffer& data,
                             const unsigned location,
                             const unsigned nEntries,
                             const unsigned offset);

  static ShaderBinding UnsignedShort(const InstancedDataBuffer& data,
                                     const unsigned location,
                                     const unsigned nEntries,
                                     const unsigned offset);

  static ShaderBinding Byte(const InstancedDataBuffer& data,
                            const unsigned location,
                            const unsigned nEntries,
                            const unsigned offset);

  static ShaderBinding UnsignedByte(const InstancedDataBuffer& data,
                                    const unsigned location,
                                    const unsigned nEntries,
                                    const unsigned offset);
...
private:
  ...
  const InstancedDataBuffer* GetInstancedData() const;
  ...
  const InstancedDataBuffer* m_referenceInstancedData = nullptr;
