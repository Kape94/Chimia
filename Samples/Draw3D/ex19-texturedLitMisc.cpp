...
main(int argc, char** argv)
{
  ...
  const auto t1 = Chimia::Draw3D::AddStaticTriangles(
    { Chimia::Draw3D::VertexPNT{
        { -1.0f, -1.0f, 0.0f }, standardNormal, { 0.0f, 0.0f } },
      Chimia::Draw3D::VertexPNT{
        { -0.5f, -1.0f, 0.0f }, standardNormal, { 0.8f, 0.0f } },
      Chimia::Draw3D::VertexPNT{
        { -0.5f, -0.5f, 0.0f }, standardNormal, { 0.8f, 1.0f } } },
    texture2);

  const auto model = Chimia::Draw3D::CreateModel(
    { Input::vertexData, Input::nVertices, Input::indices },
    Chimia::Draw3D::eVertexLayout::POSITION3_NORMAL3_TEXCOORD2);
